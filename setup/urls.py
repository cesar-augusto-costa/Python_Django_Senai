...
from todos.views import todoListarView, todoCriarView, todoAtualizarView, todoDeleteView  # Class Based Views
...
urlpatterns = [
    ...
    path("deletar/<int:pk>", todoDeleteView.as_view(), name='todo_excluir'),
